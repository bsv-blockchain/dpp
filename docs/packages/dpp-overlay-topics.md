...
**Experimental prerelease:** `@bsv/dpp-overlay-topics` 0.4.0-beta.2 is intended for implementation and interoperability testing. APIs may change significantly before a stable release; production readiness is not established.
